<template>
  ...
  <div class='page'>
    ...
    <div class='specialButton getCode' @click='getCode'>Сбросить пароль</div>
...
<script>
  ...
  import { recoverPassword } from '../api/recoverPassword.js';
      ...
      async getCode(){
        ...
        if(this.email.length<1){
          ...
          this.errorMessage='Введите email';
            ...
            let response=await recoverPassword(this.email);
